...
import (
	...
	"github.com/phenix3443/checkers"
)
...
func NewKeeper(cdc codec.BinaryCodec, addressCodec address.Codec, storeService storetypes.KVStoreService, authority string) Keeper {
	...
	k := Keeper{
		...
		StoredGames:  collections.NewMap(sb, checkers.StoredGamesKey, "stored_games", collections.StringKey, codec.CollValue[checkers.StoredGame](cdc)),
	}
