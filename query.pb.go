...
func (*QueryGetGameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_455841220462382f, []int{0}
}
...
func (*QueryGetGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_455841220462382f, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryGetGameRequest)(nil), "phenix3443.checkers.v1.QueryGetGameRequest")
	proto.RegisterType((*QueryGetGameResponse)(nil), "phenix3443.checkers.v1.QueryGetGameResponse")
}

func init() {
	proto.RegisterFile("phenix3443/checkers/v1/query.proto", fileDescriptor_455841220462382f)
}

var fileDescriptor_455841220462382f = []byte{
	...
	,
}
...
func (c *queryClient) GetGame(ctx context.Context, in *QueryGetGameRequest, opts ...grpc.CallOption) (*QueryGetGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/phenix3443.checkers.v1.Query/GetGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/phenix3443.checkers.v1.Query/GetGame",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "phenix3443.checkers.v1.Query",
	...
	Metadata: "phenix3443/checkers/v1/query.proto",
}
